...
public class GenericByWildcard {
    ...
    public static void useExtend() {
         ...
         * 但是set方法只知道传入的是个X，至于具体是X的哪个子类，不知道。
         * 总结：主要用于安全地访问数据，可以访问X及其子类型，但是不能写入非null的数据。
         */
        /**
         * Required type:
         * capture of ? extends Fruit
         * Provided:
         * Apple
         */
    ...
    public static void useSuper() {
         ...
         * 但是可以肯定的说，Object一定是它的超类，所以get方法返回Object，编译器是可以确定知道的。
         * 对于set方法来说，编译器不知道它需要的确切类型，但是X和X的子类可以安全的转型为X。
